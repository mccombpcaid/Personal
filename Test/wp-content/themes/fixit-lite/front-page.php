...
<div id="slidecaption<?php echo esc_attr($i); ?>" class="nivo-html-caption">
    <div class="top-bar">
    	...
    	<?php the_excerpt(); ?>
        <a class="slide-button" href="<?php the_permalink(); ?>"><?php echo esc_attr(get_theme_mod('slide_text',__('Get Started','fixit-lite')));?></a>
    </div>
</div>      
    <?php $i++; } ?>       
     </div>
         	...
         	<?php $page_query = new WP_Query(array('page_id' => get_theme_mod('page-setting'.$f))); ?>
         		<?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>
                          <div class="services-box">
							...
							<h3><?php the_title(); ?></h3>			
								<?php the_excerpt(); ?>
                                <a class="read-more" href="<?php the_permalink(); ?>"><?php echo esc_attr(get_theme_mod('box_text',__('Read More','fixit-lite')));?></a>
                </div><!-- services-box -->
                <?php endwhile; ?>
                <?php } } ?>
					<div class="clear"></div>
